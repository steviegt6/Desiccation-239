...
{
    public class ElectricBugSwatter : ElectricItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Swat with all your might");  //The (English) text shown below your weapon's name
        }

        public override void SetDefaults()
        {
            item.damage = 9;           //The damage of your weapon
